...
public class Board extends JPanel
{
  ...
  */
  /* For NOT JAR file*/
  Image pacmanImage = Toolkit.getDefaultToolkit().getImage("C:\\Users\\Ajay\\Documents\\PacMan\\Images\\pacman.jpg"); 
  ...
  Image gameOverImage = Toolkit.getDefaultToolkit().getImage("C:\\Users\\Ajay\\Documents\\PacMan\\Images\\gameOver.jpg"); 
  Image winScreenImage = Toolkit.getDefaultToolkit().getImage("C:\\Users\\Ajay\\Documents\\PacMan\\Images\\winScreen.jpg");
  ...
  public void paint(Graphics g)
  {
    ...
    if (clearHighScores)
    {
      ...
      if (demo)
        ...
        g.drawString("Score: "+(currScore),20,10);
      	g.drawString("High Score: "+ highScore, 300, 10);
    }
